...
tags: ["governo aberto", "transparência", "dados públicos", "participação social"]
title: "Os desafios da implementação dos princípios de governo aberto no Brasil"
type: "post"
---
...
flowchart LR
    ...
    Governo --> Dados
    Dados --> Sociedade
    Sociedade --> Fiscalizacao
    Fiscalizacao --> Governo
```
...
```mermaid
flowchart LR
    Governo --> Publicacao[Publicação de Dados]
    Publicacao --> Sociedade
    Sociedade --> Analise[Análise]
    Analise --> Controle[Controle Social]
```
